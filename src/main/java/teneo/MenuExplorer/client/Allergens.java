...
public class Allergens {
    ...
    /**
     * Constructs a new Allergens client that connects to the given base URL.
     * Sets up Feign with custom encoders, decoders, and interceptors.
     *
     * @param baseUrl The base URL of the remote allergen service.
     */
    public Allergens(String baseUrl) {
        allergens = Feign.builder()
